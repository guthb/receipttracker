    ...
    internal sealed class Configuration : DbMigrationsConfiguration<ReceiptTracker.DAL.ReceiptContext>
    {
        ...
        protected override void Seed(ReceiptTracker.DAL.ReceiptContext context)
        {
            ...
            context.Receipts.AddOrUpdate(r => r.ReceiptCapturedId,
                new ReceiptModel() { ReceiptCapturedId = 1, ReceiptType = "pdf", Receipt ="pdf", Retailer="HOME DEPOT", PurchaseDate = new DateTime(2016, 12, 01), S3BuckedId="1", Purpose =""  },
                new ReceiptModel() { ReceiptCapturedId = 2, ReceiptType = "url", Receipt = "url", Retailer = "WAL-MART", PurchaseDate = new DateTime(2016, 12, 02), S3BuckedId = "1", Purpose = "" },
                new ReceiptModel() { ReceiptCapturedId = 3, ReceiptType = "html", Receipt = "html", Retailer = "KROGER", PurchaseDate = new DateTime(2016, 12, 03), S3BuckedId = "1", Purpose = "" },
